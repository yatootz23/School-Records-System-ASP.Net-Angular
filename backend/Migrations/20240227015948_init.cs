        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradeLevel = table.Column<int>(type: "integer", nullable: false),
                    Sylabus = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teacher_Sections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "Sections",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "299a8718-fa88-4542-83b0-5640c6c77b93", null, "Admin", "ADMIN" },
                    { "40016bd1-cd02-472e-aae1-205f6db9636b", null, "Student", "STUDENT" },
                    { "c673c3da-293c-4b0e-97f7-fb5d6ca1c224", null, "Teacher", "TEACHER" }
                });
